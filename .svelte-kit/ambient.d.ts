...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies_local_cypress: string;
	...
	export const npm_package_devDependencies_svelte_windicss_preprocess: string;
	export const npm_package_devDependencies_tslib: string;
	export const npm_package_devDependencies_typescript: string;
	export const npm_package_devDependencies_vite: string;
	export const npm_package_devDependencies_vitest: string;
	export const npm_package_devDependencies_vite_plugin_vitest_typescript_assert: string;
	...
	export const npm_package_devDependencies_windicss_analysis: string;
	...
	export const npm_package_scripts_get_token: string;
	export const npm_package_scripts_lint: string;
	export const npm_package_scripts_open: string;
	export const npm_package_scripts_package: string;
	export const npm_package_scripts_preview: string;
	export const npm_package_scripts_test: string;
	export const npm_package_scripts_test_ui: string;
	export const npm_package_scripts_windi: string;
	...
	export const VITEST_CLI_WRAPPER: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies_local_cypress: string;
		...
		npm_package_devDependencies_svelte_windicss_preprocess: string;
		npm_package_devDependencies_tslib: string;
		npm_package_devDependencies_typescript: string;
		npm_package_devDependencies_vite: string;
		npm_package_devDependencies_vitest: string;
		npm_package_devDependencies_vite_plugin_vitest_typescript_assert: string;
		npm_package_devDependencies_vite_plugin_windicss: string;
		npm_package_devDependencies_windicss: string;
		npm_package_devDependencies_windicss_analysis: string;
		...
		npm_package_devDependencies__types_testing_library__jest_dom: string;
		...
		npm_package_scripts_get_token: string;
		npm_package_scripts_lint: string;
		npm_package_scripts_open: string;
		npm_package_scripts_package: string;
		npm_package_scripts_preview: string;
		npm_package_scripts_test: string;
		npm_package_scripts_test_ui: string;
		npm_package_scripts_windi: string;
